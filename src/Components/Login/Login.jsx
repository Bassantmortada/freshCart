...
<div className="text-center md:flex md:items-center md:gap-4">
  <button type="submit" className ="text-white my-2 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none
    ...
    <Link to={"/register"}>don't have an account?<span className='text-blue-600 underline'>Register Now</span></Link>
</div>
<Link to={"/forgetpassword"}><span className='text-blue-600 underline flex items-center justify-center'>Forgotten password?</span></Link>
